...
" terraform plugin basic config from : https://github.com/juliosueiras/vim-terraform-completion#vim-plug
...
let g:grammalecte_cli_py='/home/baudryo/perso/grammalect/grammalecte-cli.py'
